...
CREATE TABLE IF NOT EXISTS "public"."announcements" (
    ...
    CONSTRAINT "announcements_target_role_check" CHECK ((("target_role")::"text" = ANY ((ARRAY['all'::character varying, 'admin'::character varying, 'organizer'::character varying, 'assistant'::character varying, 'referee'::character varying, 'coach'::character varying, 'parent'::character varying, 'player'::character varying])::"text"[])))
);
...
CREATE TABLE IF NOT EXISTS "public"."users" (
    ...
    "created_at" timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    "updated_at" timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "users_role_check" CHECK ((("role")::"text" = ANY ((ARRAY['account_owner'::character varying, 'admin'::character varying, 'organizer'::character varying, 'assistant'::character varying, 'referee'::character varying, 'coach'::character varying, 'parent'::character varying, 'player'::character varying])::"text"[])))
);
...
CREATE INDEX "idx_registrations_parent_id" ON "public"."registrations" USING "btree" ("parent_id");
...
CREATE INDEX "idx_venues_geo_location" ON "public"."venues" USING "gist" ("geo_location");
...
ALTER TABLE ONLY "public"."leagues"
    ADD CONSTRAINT "leagues_account_owner_id_fkey" FOREIGN KEY ("account_owner_id") REFERENCES "public"."users"("id");
...
ALTER TABLE ONLY "public"."registrations"
    ADD CONSTRAINT "registrations_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "public"."users"("id");

ALTER TABLE ONLY "public"."registrations"
    ADD CONSTRAINT "registrations_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "public"."players"("id");

ALTER TABLE ONLY "public"."teams"
    ADD CONSTRAINT "teams_coach_id_fkey" FOREIGN KEY ("coach_id") REFERENCES "public"."users"("id");
...
CREATE POLICY "delete_own_announcements" ON "public"."announcements" FOR DELETE USING (((( SELECT "users"."role"
   FROM "public"."users"
  WHERE ("users"."id" = "auth"."uid"())))::"text" = ANY ((ARRAY['admin'::character varying, 'organizer'::character varying])::"text"[])));

CREATE POLICY "delete_own_events" ON "public"."events" FOR DELETE USING (("team_id" IN ( SELECT "teams"."id"
   FROM "public"."teams"
  WHERE (("teams"."coach_id" = "auth"."uid"()) OR ("teams"."league_id" IN ( SELECT "leagues"."id"
           FROM "public"."leagues"
          WHERE ("leagues"."account_owner_id" = "auth"."uid"())))))));

CREATE POLICY "delete_own_leagues" ON "public"."leagues" FOR DELETE USING (("account_owner_id" = "auth"."uid"()));

CREATE POLICY "delete_own_players" ON "public"."players" FOR DELETE USING (("user_id" = "auth"."uid"()));

CREATE POLICY "delete_own_registrations" ON "public"."registrations" FOR DELETE USING (("parent_id" = "auth"."uid"()));

CREATE POLICY "delete_own_teams" ON "public"."teams" FOR DELETE USING ((("coach_id" = "auth"."uid"()) OR ("league_id" IN ( SELECT "leagues"."id"
   FROM "public"."leagues"
  WHERE ("leagues"."account_owner_id" = "auth"."uid"())))));

CREATE POLICY "delete_own_user" ON "public"."users" FOR DELETE USING (("id" = "auth"."uid"()));

CREATE POLICY "delete_venues" ON "public"."venues" FOR DELETE USING (((( SELECT "users"."role"
   FROM "public"."users"
  WHERE ("users"."id" = "auth"."uid"())))::"text" = ANY ((ARRAY['admin'::character varying, 'organizer'::character varying])::"text"[])));

ALTER TABLE "public"."events" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "insert_own_announcements" ON "public"."announcements" FOR INSERT WITH CHECK (((( SELECT "users"."role"
   FROM "public"."users"
  WHERE ("users"."id" = "auth"."uid"())))::"text" = ANY ((ARRAY['admin'::character varying, 'organizer'::character varying])::"text"[])));

CREATE POLICY "insert_own_events" ON "public"."events" FOR INSERT WITH CHECK (("team_id" IN ( SELECT "teams"."id"
   FROM "public"."teams"
  WHERE ("teams"."coach_id" = "auth"."uid"()))));

CREATE POLICY "insert_own_leagues" ON "public"."leagues" FOR INSERT WITH CHECK (("account_owner_id" = "auth"."uid"()));

CREATE POLICY "insert_own_messages" ON "public"."messages" FOR INSERT WITH CHECK (("sender_id" = "auth"."uid"()));

CREATE POLICY "insert_own_players" ON "public"."players" FOR INSERT WITH CHECK (("user_id" = "auth"."uid"()));

CREATE POLICY "insert_own_registrations" ON "public"."registrations" FOR INSERT WITH CHECK (("parent_id" = "auth"."uid"()));

CREATE POLICY "insert_own_teams" ON "public"."teams" FOR INSERT WITH CHECK (("coach_id" = "auth"."uid"()));

CREATE POLICY "insert_own_user" ON "public"."users" FOR INSERT WITH CHECK (("id" = "auth"."uid"()));

CREATE POLICY "insert_venues" ON "public"."venues" FOR INSERT WITH CHECK (((( SELECT "users"."role"
   FROM "public"."users"
  WHERE ("users"."id" = "auth"."uid"())))::"text" = ANY ((ARRAY['admin'::character varying, 'organizer'::character varying])::"text"[])));
...
CREATE POLICY "no_delete_messages" ON "public"."messages" FOR DELETE USING (false);

CREATE POLICY "no_update_messages" ON "public"."messages" FOR UPDATE USING (false);

ALTER TABLE "public"."players" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "public"."registrations" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "select_own_announcements" ON "public"."announcements" FOR SELECT USING (((("target_role")::"text" = 'all'::"text") OR (("target_role")::"text" = (( SELECT "users"."role"
   FROM "public"."users"
  WHERE ("users"."id" = "auth"."uid"())))::"text")));

CREATE POLICY "select_own_events" ON "public"."events" FOR SELECT USING (("team_id" IN ( SELECT "teams"."id"
   FROM "public"."teams"
  WHERE (("teams"."coach_id" = "auth"."uid"()) OR ("teams"."league_id" IN ( SELECT "leagues"."id"
           FROM "public"."leagues"
          WHERE ("leagues"."account_owner_id" = "auth"."uid"())))))));

CREATE POLICY "select_own_leagues" ON "public"."leagues" FOR SELECT USING (("account_owner_id" = "auth"."uid"()));

CREATE POLICY "select_own_messages" ON "public"."messages" FOR SELECT USING ((("sender_id" = "auth"."uid"()) OR ("recipient_id" = "auth"."uid"())));

CREATE POLICY "select_own_players" ON "public"."players" FOR SELECT USING (("user_id" = "auth"."uid"()));

CREATE POLICY "select_own_registrations" ON "public"."registrations" FOR SELECT USING (("parent_id" = "auth"."uid"()));

CREATE POLICY "select_own_teams" ON "public"."teams" FOR SELECT USING ((("coach_id" = "auth"."uid"()) OR ("league_id" IN ( SELECT "leagues"."id"
   FROM "public"."leagues"
  WHERE ("leagues"."account_owner_id" = "auth"."uid"())))));
...
CREATE POLICY "update_own_announcements" ON "public"."announcements" FOR UPDATE USING (((( SELECT "users"."role"
   FROM "public"."users"
  WHERE ("users"."id" = "auth"."uid"())))::"text" = ANY ((ARRAY['admin'::character varying, 'organizer'::character varying])::"text"[]))) WITH CHECK (((( SELECT "users"."role"
   FROM "public"."users"
  WHERE ("users"."id" = "auth"."uid"())))::"text" = ANY ((ARRAY['admin'::character varying, 'organizer'::character varying])::"text"[])));

CREATE POLICY "update_own_events" ON "public"."events" FOR UPDATE USING (("team_id" IN ( SELECT "teams"."id"
   FROM "public"."teams"
  WHERE (("teams"."coach_id" = "auth"."uid"()) OR ("teams"."league_id" IN ( SELECT "leagues"."id"
           FROM "public"."leagues"
          WHERE ("leagues"."account_owner_id" = "auth"."uid"()))))))) WITH CHECK (("team_id" IN ( SELECT "teams"."id"
   FROM "public"."teams"
  WHERE (("teams"."coach_id" = "auth"."uid"()) OR ("teams"."league_id" IN ( SELECT "leagues"."id"
           FROM "public"."leagues"
          WHERE ("leagues"."account_owner_id" = "auth"."uid"())))))));

CREATE POLICY "update_own_leagues" ON "public"."leagues" FOR UPDATE USING (("account_owner_id" = "auth"."uid"())) WITH CHECK (("account_owner_id" = "auth"."uid"()));

CREATE POLICY "update_own_players" ON "public"."players" FOR UPDATE USING (("user_id" = "auth"."uid"())) WITH CHECK (("user_id" = "auth"."uid"()));

CREATE POLICY "update_own_registrations" ON "public"."registrations" FOR UPDATE USING (("parent_id" = "auth"."uid"())) WITH CHECK (("parent_id" = "auth"."uid"()));

CREATE POLICY "update_own_teams" ON "public"."teams" FOR UPDATE USING ((("coach_id" = "auth"."uid"()) OR ("league_id" IN ( SELECT "leagues"."id"
   FROM "public"."leagues"
  WHERE ("leagues"."account_owner_id" = "auth"."uid"()))))) WITH CHECK ((("coach_id" = "auth"."uid"()) OR ("league_id" IN ( SELECT "leagues"."id"
   FROM "public"."leagues"
  WHERE ("leagues"."account_owner_id" = "auth"."uid"())))));

CREATE POLICY "update_own_user" ON "public"."users" FOR UPDATE USING (("id" = "auth"."uid"())) WITH CHECK (("id" = "auth"."uid"()));

CREATE POLICY "update_venues" ON "public"."venues" FOR UPDATE USING (((( SELECT "users"."role"
   FROM "public"."users"
  WHERE ("users"."id" = "auth"."uid"())))::"text" = ANY ((ARRAY['admin'::character varying, 'organizer'::character varying])::"text"[]))) WITH CHECK (((( SELECT "users"."role"
   FROM "public"."users"
  WHERE ("users"."id" = "auth"."uid"())))::"text" = ANY ((ARRAY['admin'::character varying, 'organizer'::character varying])::"text"[])));
